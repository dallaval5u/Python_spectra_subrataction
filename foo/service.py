...
service_logger = logging.getLogger("foo.service")  # Configuring child logger
...
service_vars = {
    ...
    "INIT_FILE_NAME": os.path.dirname(os.path.dirname(os.path.abspath(__file__))) + "/data/foo.init",
